...
describe("#desafioJusta 1 - Eu, como Herói, desejo realizar a compra de produto e alterar o endereço de entrega",()=>{
  beforeEach(()=>{
  ...
  //Retornando a Página de endereços para proseguimento
